...
function OddballRoutineBegin(snapshot) {
  return async function () {
    ...
    OddballComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function routine_2backRoutineBegin(snapshot) {
  return async function () {
    ...
    routine_2backComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function routine_2bendRoutineBegin(snapshot) {
  return async function () {
    ...
    routine_2bendComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function routine_3backRoutineBegin(snapshot) {
  return async function () {
    ...
    routine_3backComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function routine_3bendRoutineBegin(snapshot) {
  return async function () {
    ...
    routine_3bendComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function routine_4backRoutineBegin(snapshot) {
  return async function () {
    ...
    routine_4backComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
